...
BARRAGENS_POR_EVENTO = {
    # CORRIGIDO: em 1983 operavam a SUL e a NORTE; a OESTE estava em obras.
    # O valor anterior ("sul", "oeste") estava trocado, e a diferenca nao e
    # pequena -- a Norte tem 357 hm3, mais que as outras duas somadas.
    "1983": {"sul", "norte"},          # Oeste em construcao
