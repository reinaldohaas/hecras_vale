...
ax.plot(2.2, 7.2, 's', color='#d62728', markersize=14, zorder=5)
ax.plot(2.2, 4.8, 's', color='#d62728', markersize=14, zorder=5)
ax.plot(6.0, 7.5, 's', color='#d62728', markersize=14, zorder=5)
...
cidades = [
    (4.0, 6.0, 'Rio do Sul\n(Junção Sul + Oeste + Norte)', (-30, -35)),
    (9.8, 6.0, 'Blumenau\n(Ponto Crítico de Nível)', (0, 15)),
    (11.5, 5.8, 'Itajaí / Brusque\n(Foz + Itajaí-Mirim)', (10, -25))
]
...
ax.set_title('Rede Hidrográfica Real e Sistema de Barragens da Bacia do Itajaí', fontsize=14, fontweight='bold', pad=15)
ax.axis('off')
...
ax.set_title('Perfil Longitudinal de Declividade da Bacia do Itajaí com Dados REAIS', fontsize=13, fontweight='bold')
...
# FIGURA 3
print("Gerando Figura 3: Amortecimento de Cheias...")
fig, ax = plt.subplots(figsize=(10, 5), dpi=300)
...
ax.set_title('Efeito Prático das 3 Barragens + Itajaí-Mirim e Itajaí-Açu', fontsize=13, fontweight='bold')
ax.legend(loc='upper right', frameon=True, facecolor='white')
ax.grid(True, linestyle=':', alpha=0.6)
save_fig_safely(fig, "figura_3_hidrogramas_e_amortecimento.png")
plt.close(fig)

print("SUCESSO: Todas as figuras foram geradas!")
